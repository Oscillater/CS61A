...
def copycat(lst1, lst2):
    ...
    ['c', 'c', 'c']
    """
    def copycat_helper(lst1, num1, num2):
        if num2>=len(lst2) or num1>=len(lst1):
            return lst1[:num1]
        if lst2[num2]>=0:
            lst1[num1:num1+1] = [lst1[num1]]*lst2[num2]
        else:
            lst1[num1+lst2[num2]:num1+1] = [][:]
        return copycat_helper(lst1,num1+lst2[num2],num2+1)
    return copycat_helper(lst1,0,0)
